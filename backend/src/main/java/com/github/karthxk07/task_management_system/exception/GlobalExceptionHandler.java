...
import com.github.karthxk07.task_management_system.payload.ErrorDetail;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ErrorDetail> handleSecurityException(SecurityException ex, WebRequest request) {
    ErrorDetail errorDetail = new ErrorDetail(
        new Date(),
        ex.getMessage(),
        request.getDescription(false));
